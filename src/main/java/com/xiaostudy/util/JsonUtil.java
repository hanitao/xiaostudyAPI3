...
/**
 * JSON格式化工具
 * @author StarlightFu  https://www.cnblogs.com/starlightfu/p/6582700.html
 *
 */
public class JsonUtil {
    ...
    public static boolean validation(String json){
        ...
        try {
            ...
            System.out.println("执行JSON校验JS异常");
        } finally {
            try {
                if (reader != null) {
                    reader.close();
    ...
    public static String format(String jsonStr){
        ...
        valResult = JsonUtil.validation(jsonStr);
        if (!valResult) {
            System.out.println("执行JSON校验JS异常");
        }
    ...
    public static String formatAndColoring(String json){
        return JsonUtil.coloring(JsonUtil.format(json));
    }
    ...
    public static String removeSpaceAndEscape(String jsonStr){
        jsonStr = JsonUtil.removeSpace(jsonStr);
    ...
    public static void main(String[] args) {
        ...
        System.out.println(JsonUtil.format(jsonStr));
//        System.out.println(JsonUtil.coloring(JsonUtil.format(jsonStr)));
    }
}